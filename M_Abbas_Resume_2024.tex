...
\resumeItemListStart
\resumeItem{\textbf{Teaching Assistant for Data Structures \& Algorithms:}
Assisted students during labs and with assignments.}
\resumeItem{\textbf{Git \& Github Workshop Instructor:} Conducted
...
\resumeProjectHeading
{\titleItem{Cortex: ETL Data Pipelines} $|$ \emph{Spark, Airflow, Kafka, Trino, AWS Cloud, PostgreSQL}}{Aug 2023 - May 2024}
\resumeItemListStart
...
\resumeProjectHeading
{\titleItem{Yohsin: Blazing-Fast Object Serialization Tool (Hackathon)} $|$ \emph{Rust}}{01 Jan 2025}
\resumeItemListStart
\resumeItem{A Deep Learning framework to estimate population parameters of
Binary Black holes under the leadership of RIT instructor, the framework was
based on Normalizing flows for inference and Neural Nets for summarization and
...
\resumeProjectHeading
{\titleItem{Astroflow: Bayesian Flow Networks Based Model} $|$ \emph{PyTorch, Django, Postgres, SQLite, Javascript}}{Aug 2023 - May 2024}
\resumeItemListStart
\resumeItem{A Deep Learning framework to estimate population parameters of
